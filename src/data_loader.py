...
class Data(object):
    ...
    def _build_vocabularies(self):
        self.words.build_vocab(self.train.dataset + self.test.dataset)
        self.lab.build_vocab(self.train.dataset + self.test.dataset)
        self.char.build_vocab(self.train.dataset + self.test.dataset)
